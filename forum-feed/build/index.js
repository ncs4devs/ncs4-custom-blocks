...
/* harmony import */ var _js_edit_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../js/edit-component */ "../js/edit-component.js");
/* harmony import */ var _js_hooks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../js/hooks */ "../js/hooks.js");
...
function Edit(props) {
  let [state, setAttribute, setState] = (0,_js_hooks__WEBPACK_IMPORTED_MODULE_3__.withAttributes)(props.attributes, props.setAttributes, { ...props.attributes
  }, {
    ref: s => Number(s) < 0 ? undefined : s
  });
  let [forums, setForums] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(null);
  (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    getForums(setForums);
  }, []);
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_js_edit_component__WEBPACK_IMPORTED_MODULE_2__["default"], (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, {
    save: Markup,
    state: state,
    ...
    controlPanels: [{
      ...
      controls: [{
        ...
        help: state.showNewTopicLink ? "A link to create a new topic is shown" : "No link is shown",
...
async function getForums(callback) {
  fetch("/wp-json/wp/v2/forum").then(response => response.json()).then(forums => {
...
function getForumTitles(forums) {
  let titles = [{
    value: "-1",
    label: "---Please select a Forum---"
  }];

  if (forums && forums != null && (forums.length > 0 || Object.keys(forums).length > 0)) {
...
function Markup(props) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, blockProps, {
    ...
    className: ["ncs4-forum-feed", blockProps.className].join(' ')
...
/* harmony import */ var _save_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_save_js__WEBPACK_IMPORTED_MODULE_6__);
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)("ncs4-custom-blocks/forum-feed", {
  apiVersion: 2,
  title: 'Forum Feed',
  icon: 'rss',
  category: 'widget',
