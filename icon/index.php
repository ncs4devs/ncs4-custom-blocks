...
/*
 * Plugin Name: NCS4 Custom Blocks Icon Block
 * Plugin URI: https://ncs4.usm.edu
 * Description: A plugin which implements a basic icon block
...
function ncs4_custom_blocks_register_icon() {
...
add_action( 'init', 'ncs4_custom_blocks_register_icon');
