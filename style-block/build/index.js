...
/* harmony export */   "ColorSelector": function() { return /* binding */ ColorSelector; },
/* harmony export */   "createColorClass": function() { return /* binding */ createColorClass; },
/* harmony export */   "createColorStyle": function() { return /* binding */ createColorStyle; },
/* harmony export */   "fromColorAttribute": function() { return /* binding */ fromColorAttribute; },
/* harmony export */   "verifyColor": function() { return /* binding */ verifyColor; }
/* harmony export */ });
...
function fromColorAttribute(attr) {
  let bg = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
class ColorSelector extends (react__WEBPACK_IMPORTED_MODULE_1___default().Component) {
  render() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ButtonControl": function() { return /* binding */ ButtonControl; },
/* harmony export */   "ListControl": function() { return /* binding */ ListControl; }
/* harmony export */ });
...
let Button = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].button`
...
function ButtonControl(props) {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(Button, (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, {
    className: ["ncs4-component__button", props.disabled ? "disabled" : null, props.className].join(" "),
    style: {
  ...
  }), props.dashicon && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("span", {
    className: "dashicons dashicons-" + props.dashicon,
    style: {
      fontSize: props.iconSize ? props.iconSize : null,
      width: "auto",
      height: "auto",
      transform: props.iconTranslation && "translate(" + props.iconTranslation + ")"
    }
  }), " "), props.label);
...
class Edit extends (react__WEBPACK_IMPORTED_MODULE_1___default().Component) {
  constructor(props) {
    super(props);
  ...
  createSelectorFromRule(rule, prefix) {
    ...
    for (let selector of selectors) {
      ...
      let selectorString = selector.value.split(",").reduce((str, sel) => str !== "" ? str + "," + prefix + delim + sel : str + prefix + delim + sel, "");
  ...
  updateSelected(index) {
    let rules = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.state.rules;
  ...
  reduceAction(action) {
    switch (action.type) {
      ...
      case "delete":
        {
          let deletedIndex;
          let rules = this.state.rules.reduce((_ref, rule) => {
            let {
              arr,
              index
            } = _ref;
      ...
      case "moveIndexDown":
        {
          ...
          let newIndex;
          let rules = this.state.rules.map((rule, i, arr) => {
            if (i === action.index) {
              newIndex = i - 1;
              return arr[newIndex];
            }
          ...
          this.updateSelected(action.swapIndexes ? action.index : newIndex, rules);
          break;
        }
  ...
  render() {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_save__WEBPACK_IMPORTED_MODULE_7__["default"], {
      ...
      title: "Style rules",
      initialOpen: true
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_js_UIControls__WEBPACK_IMPORTED_MODULE_5__.ButtonControl, {
    ...
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(RulesList, {
      rules: this.state.rules,
      ...
      disabled: this.state.selectedRule == null || this.state.rules.length - this.state.selectedRuleIndex < 2
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_js_UIControls__WEBPACK_IMPORTED_MODULE_5__.ButtonControl, {
      ...
      iconSize: "45px",
      iconTranslation: "-18px, -15px",
      disabled: this.state.selectedRule == null || this.state.selectedRuleIndex < 1
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", {
      style: {
        borderColor: "black"
      }
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(RuleSettings, {
      rules: this.state.rules,
      selected: this.state.selectedRule,
...
function RulesList(props) {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_js_UIControls__WEBPACK_IMPORTED_MODULE_5__.ListControl, {
    ...
    getValue: rule => {
      let chars = 15;
      let out = rule.selectors && rule.selectors.length ? (0,_js_utils__WEBPACK_IMPORTED_MODULE_6__.normalizeStringLength)(rule.selectors.reduce((str, sel) => str + capitalize(sel.type) + ", ", "").slice(0, -2), chars, false) : (0,_js_utils__WEBPACK_IMPORTED_MODULE_6__.normalizeStringLength)("<No Selectors>", chars, false);
      out += " | ";
      out += rule.properties && rule.properties.length ? (0,_js_utils__WEBPACK_IMPORTED_MODULE_6__.normalizeStringLength)(rule.properties.reduce((str, prop) => str + capitalize(prop.type) + ", ", "").slice(0, -2), chars, false) : (0,_js_utils__WEBPACK_IMPORTED_MODULE_6__.normalizeStringLength)("<No Properties>", chars, false);
      return out;
    },
...
function RuleSettings(props) {
  let [selectedPane, selectPane] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("selectors");
  let panes = [{
    value: "selectors",
    text: "Selectors"
  }, {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_js_UIControls__WEBPACK_IMPORTED_MODULE_5__.ButtonControl, {
  ...
  })), selectedPane === "selectors" && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(SelectorsSettingsPane, {
    selectors: currentRule.selectors,
    onChange: handleSelectorUpdate
  }), selectedPane === "properties" && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PropertiesSettingsPane, {
...
function SelectorsSettingsPane(props) {
  let [currentSelector, setSelector] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(props.selectors && props.selectors[0] ? 0 : null);
  let [customCss, setCustomCss] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  ...
  let reduceAction = action => {
    switch (action.type) {
      ...
      case "delete":
        {
          props.onChange(selectors.filter((_, index) => index !== action.index));
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_js_UIControls__WEBPACK_IMPORTED_MODULE_5__.ListControl, {
  ...
  }), currentSelector != null && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
function PropertiesSettingsPane(props) {
  ...
  let [currentProperty, setProperty] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(props.properties && props.properties[0] ? 0 : null);
  let [customCss, setCustomCss] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  let [knowsCss, setKnowsCss] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(0); // 1 is success, -3 is max tries

  let [cssPassword, setCssPassword] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
  ...
  let reduceAction = action => {
    switch (action.type) {
      ...
      case "delete":
        {
          props.onChange(properties.filter((_, index) => index !== action.index));
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }), currentProperty != null && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    onChange: handleTypeChange,
    disabled: properties.length < 1
  }), propertyData && propertyData.type === "custom" && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
...
class Save extends (react__WEBPACK_IMPORTED_MODULE_2___default().Component) {
  render() {
    let attrs = this.props.attributes;
    let backend = this.props.backend || false;
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, this.props.blockProps, {
      id: attrs.id,
      className: ["ncs4-style-block", this.props.blockProps.className].join(' ')
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("style", null, attrs.style), backend ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InnerBlocks, null) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InnerBlocks.Content, null));
  }
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)('ncs4-custom-blocks/style-block', {
  apiVersion: 2,
  title: 'Style',
  ...
  edit: props => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_edit_js__WEBPACK_IMPORTED_MODULE_4__["default"], (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, {
    blockProps: (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.useBlockProps)()
  })),
  save: props => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_save_js__WEBPACK_IMPORTED_MODULE_5__["default"], (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, {
