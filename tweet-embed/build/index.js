...
function Save(props) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, blockProps, {
    ...
    className: ["ncs4-tweet-embed", blockProps.className].join(' ')
  }), props.backend ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "ncs4-tweet-embed__embed-content",
    dangerouslySetInnerHTML: {
      __html: `<a class="twitter-timeline" href="` + attributes.pageLink + `" style="height: 700px;">Tweets by NCS4usm</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>`
    }
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockType)("ncs4-custom-blocks/tweet-embed", {
  apiVersion: 2,
  title: 'Tweet Embed',
  icon: 'index-card',
  category: 'layout',
