...
/* harmony import */ var _js_SelectControls__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../js/SelectControls */ "../js/SelectControls.js");
/* harmony import */ var _popup_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./popup.js */ "./src/popup.js");
/* harmony import */ var _js_ColorSelector_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../js/ColorSelector.js */ "../js/ColorSelector.js");
...
class PopupEdit extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  ...
  componentDidMount() {
    Object(_popup_js__WEBPACK_IMPORTED_MODULE_7__["reserveId"])(x => this.setStateAttributes({
      id: x
    }), this.state.id);
    this.setStateAttributes({
      bgColor: {
        color: Object(_js_ColorSelector_js__WEBPACK_IMPORTED_MODULE_8__["verifyColor"])(this.state.bgColor),
        slug: this.state.bgColor.slug
      }
    });
    this.setStateAttributes({
      textColor: {
        color: Object(_js_ColorSelector_js__WEBPACK_IMPORTED_MODULE_8__["verifyColor"])(this.state.textColor),
  ...
  componentWillUnmount() {
    Object(_popup_js__WEBPACK_IMPORTED_MODULE_7__["deleteId"])(this.state.id);
  }

  createClassName(classes) {
    return ['ncs4-popup', _popup_js__WEBPACK_IMPORTED_MODULE_7__["Popup"].classType, // for some reason, selection isn't working
  ...
  render() {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, this.props.blockProps, {
    ...
    }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_popup_js__WEBPACK_IMPORTED_MODULE_7__["Popup"], {
      attributes: this.state
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__["InnerBlocks"], null)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__["InspectorControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_popup_js__WEBPACK_IMPORTED_MODULE_7__["PopupSettings"], {
      attributes: this.state,
      ...
      title: "Link settings",
      initialOpen: true
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_js_SelectControls__WEBPACK_IMPORTED_MODULE_6__["OptionsControl"], {
      options: [{
        attribute: 'linkStyle',
        label: 'Link style',
        default: '',
        value: this.state.linkStyle,
        choices: _popup_js__WEBPACK_IMPORTED_MODULE_7__["Popup"].linkOptions
      }],
...
class Popup extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  render() {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, this.props.backend ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("a", {
      className: "ncs4-popup-button " + (this.props.className || "") + " " + (attrs.linkStyle || ""),
      href: "#"
...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(Popup, "linkOptions", [{
  value: '',
  label: 'Link'
}, {
