...
/*
 * Plugin Name: NCS4 Custom Blocks container block
 * Plugin URI: https://ncs4.usm.edu
 * Description: A plugin which adds a simple container block
...
function ncs4_custom_blocks_register_container() {
...
add_action( 'init', 'ncs4_custom_blocks_register_container');
